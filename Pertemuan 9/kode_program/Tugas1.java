...
class Pakaian2{
    ...
    Pakaian2(String jenis, String warna, String merk, String ukuran, double harga){
        this.jenis=jenis;
        this.warna=warna;
        this.merk=merk;
        this.ukuran=ukuran;
...
class Stack2{
    ...
    public void getMin(){
        ...
        System.out.println(mn.jenis + " " + mn.warna + " " + mn.merk + " " +mn.ukuran +" "+ min);
    }
}
public class Tugas1 {
    public static void main(String[] args) {
        ...
        do{
            ...
            System.out.println("5. Data harga pakaian terendah");
            ...
            if(choose==1){
                ...
                do{
                    ...
                    Pakaian2 p = new Pakaian2(jenis, warna, merk, ukuran, harga);
